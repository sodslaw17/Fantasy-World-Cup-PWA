"use client";
// ============================================================
// app/(app)/draft/standby-screen.tsx — PRE-DRAFT "Draft" tab landing
// ------------------------------------------------------------
// Worked port of the prototype's StandbyScreen
// (reference/prototype-src/app/screens_knockout.jsx). This is what the
// "Draft" tab renders during the pre-draft phase: a live countdown to
// the knockout draft, what-happens-next, and the user's draft position.
// A CTA opens the full Draft Order page (draft-prefs-screen.tsx).
//
// MARKUP only. Countdown target + standby copy + draft position come
// from props — wire to your settings/standings queries.
// ============================================================
...
export function StandbyScreen({
  ...
  draftAtISO: string;            // e.g. "2026-06-28T16:00:00Z"
  standbyBody: string;           // settings.draft_standby_text
  draftPosition: number;         // set by group-stage rank
  teamCount?: number;
  ...
  return (
    <>
      <ScreenHeader title="Draft Standby" sub="Pre-draft · Jun 28 morning" waveIntensity={waveIntensity} />
      <Scroll>
        {/* hero countdown */}
        <div className="relative overflow-hidden rounded-lg bg-ink px-5 pt-[22px] pb-6 shadow-md">
          ...
          <div className="relative">
            <div className="mb-3 text-[12px] font-bold uppercase tracking-[.08em] text-gold">
